...
For communication with other agents, use ONLY plain text tags:
```
...
- **Parallel**: You may brainstorm alongside Researchers (who gather facts) — coordinate via [TO:] so your ideas stay grounded.
